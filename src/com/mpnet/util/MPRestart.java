...
public class MPRestart extends Thread {
	private static final String	LINUX_LAUNCHER	= "./server_run.sh";
	private static final String	OSX_LAUNCHER	= "./server_run.sh";
	private static final String	WIN_LAUNCHER	= "server_run.bat";
	...
	public MPRestart() {
		setName(":::MPRestarter:::");
		this.log = LoggerFactory.getLogger(MPRestart.class);
